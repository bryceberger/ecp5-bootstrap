...
build/v: $(sim_source)
	...
	@sv2v --siloed -w adjacent $(sim_source)
...
obj_dir/Vspi: $(sim_source) $(tb_source)
	@verilator -cc -O3 --trace --trace-fst --top-module spi $(sim_source) \
		-Wno-WIDTHTRUNC -Wno-WIDTHEXPAND --exe $(tb_source)
